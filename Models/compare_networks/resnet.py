...
def resnet34(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_dict=model_zoo.load_url(model_urls['resnet34'],model_dir='/data/project_ddw/0112_skin_lesion_segment/CA-Net-master/Models/compare_networks/')# Modify 'model_dir' according to your own path
